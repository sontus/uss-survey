                    ...
                    <div class="card w-100 h-100">
                        <div class="card-body">
                            <div class="title text-center w-100 mt-5 mb-4">
                                <h5>Preliminary Period Result </h5>
                            </div>
                            <br>
                            <form action="{{ route('task-information') }}" method="post">
                                @csrf
                                <div class="question">
                                    <p>You have correctly recorded answers for &nbsp;
                                        <input
                                            style="background-color: white;border:1px solid black; color:#000; text-align: center;width: 80px;"
                                            type="number" value="" id="result"
                                            min="1" disabled>&nbsp;boxes.</p>
                                    <input type="hidden" name="preliminary" class="preliminaryResult">
...
@push('page-js')
    <script>
        ...
        if (!corAns || corAns < 0) corAns = 0;
        $('#result').val(corAns);
        $('.preliminaryResult').val(corAns);
    </script>
@endpush
