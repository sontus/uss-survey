                ...
                <div class="col-12 main_card">
                    <div class="card w-100 h-100">
                        <div class="card-body">
                            ...
                            <br>
                            <form action="{{ route('page-fifty-two-save')}}" method="POST">
                                @csrf

                                @if (checkVersion() == "C" || checkVersion() == "D")
                                    <input type="hidden" name="next_page" value="page-fifty-four">
                                @elseif(checkVersion() == "A" || checkVersion() == "B")
                                    <input type="hidden" name="next_page" value="page-fifty-three">
                                @else
                                    <input type="hidden" name="next_page" value="page-fifty-five">
                                @endif


                                <input type="hidden" name="current_page" value="52">
                                ...
                                <div class="question">
                                    ...
                                    <p>(1) To what extent do you feel competitive against those colleagues who would be
                                        able to view the descriptions of your identified shortcut/s?</p>
