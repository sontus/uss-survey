                ...
                <div class="col-12 main_card">
                    <div class="card w-100 h-100">
                        <div class="card-body">
                            ...
                            <br>
                            <form action="{{ route('page-forty-nine-save')}}" method="POST">
                                @csrf
                                ...
                                <div class="question">
                                    <p>(4) How <u>warm</u> do you feel toward those of your colleagues who rank very
                                        low?</p>
                                ...
                                <label for="warm_seven">7</label></span>
                                    ...
                                    {{-- 2nd --}}
                                    <p class="mt-3">(5) How <u>tender</u> do you feel toward those of your colleagues who rank very
                                        low?</p>
                                ...
                                <label for="seven-q1">7</label></span>
                                    ...
                                    {{-- 3rd --}}
                                    <p class="mt-3">(6) How <u>moved</u> do you feel toward those of your colleagues who rank very
                                        low?</p>
