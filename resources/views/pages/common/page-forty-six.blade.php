                ...
                <div class="col-12 main_card">
                    <div class="card w-100 h-100">
                        <div class="card-body">
                            ...
                            <br>
                            <form action="{{ route('page-forty-six-save')}}" method="POST">
                                @csrf
                                <input type="hidden" name="next_page" value="page-forty-seven">
                                ...
                                <div class="question">
                                    ...
                                    <p>(1) To what extent did you consider the perspective of your colleagues who rank
                                        very low in the competition (i.e., colleagues that has a performance rank of 4
                                        or 5)?</p>
