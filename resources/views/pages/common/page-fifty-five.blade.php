                ...
                <div class="col-12 main_card">
                    <div class="card w-100 h-100">
                        <div class="card-body">
                            ...
                            <br>
                            <form action="{{ route('page-fifty-five-save')}}" method="POST">
                                @csrf
                                <input type="hidden" name="next_page" value="page-fifty-six">
                                <input type="hidden" name="current_page" value="55">
                                <input type="hidden" name="question_set" value="All">
                                <input type="hidden" name="question_part" value="I">
                                <div class="question">
