                ...
                <div class="col-12 main_card">
                    <div class="card w-100 h-100">
                        <div class="card-body">
                            ...
                            <br>
                            <form action="{{ route('page-sixty-save')}}" method="POST">
                                @csrf
                                <input type="hidden" name="next_page" value="page-sixty-one">
                                <input type="hidden" name="current_page" value="60">
                                ...
                                <div class="question">
                                    <p><strong>PART M: To what extent do you agree or disagree with the following
                                            statements.</strong></p>
                                    <p>(4) I feel worried about those of my colleagues who rank very low </p>

                                    <div class="number_radio d-flex justify-content-between">
                                <span><input type="radio" id="warm_one" name="question_four" value="1">
                                <label for="warm_one">1</label></span>
                                        <span><input type="radio" id="warm_two" name="question_four" value="2">
                                <label for="warm_two">2</label></span>
                                        <span><input type="radio" id="warm_three" name="question_four" value="3">
                                <label for="warm_three">3</label></span>
                                        <span><input type="radio" id="warm_four" name="question_four" value="4">
                                <label for="warm_four">4</label></span>
                                        <span><input type="radio" id="warm_five" name="question_four" value="5">
                                <label for="warm_five">5</label></span>
                                        <span><input type="radio" id="warm_six" name="question_four" value="6">
                                <label for="warm_six">6</label></span>
                                        <span><input type="radio" id="warm_seven" name="question_four" value="7">
                                <label for="warm_seven">7</label></span>
                                    ...
                                    {{-- 2nd --}}
                                    <p class="mt-3">(5) I feel upset about those of my colleagues who rank very low </p>

                                    <div class="number_radio d-flex justify-content-between">
                                <span><input type="radio" id="one-q1" name="question_five" value="1">
                                <label for="one-q1">1</label></span>
                                        <span><input type="radio" id="two-q1" name="question_five" value="2">
                                <label for="two-q1">2</label></span>
                                        <span><input type="radio" id="three-q1" name="question_five" value="3">
                                <label for="three-q1">3</label></span>
                                        <span><input type="radio" id="four-q1" name="question_five" value="4">
                                <label for="four-q1">4</label></span>
                                        <span><input type="radio" id="five-q1" name="question_five" value="5">
                                <label for="five-q1">5</label></span>
                                        <span><input type="radio" id="six-q1" name="question_five" value="6">
                                <label for="six-q1">6</label></span>
                                        <span><input type="radio" id="seven-q1" name="question_five" value="7">
                                <label for="seven-q1">7</label></span>
                                    ...
                                    {{-- 3rd --}}
                                    <p class="mt-3">(6) I currently don’t pay attention to the questions I am being asked in the
                                        survey</p>

                                    <div class="number_radio d-flex justify-content-between">
                                <span><input type="radio" id="one-q2" name="question_six" value="1">
                                <label for="one-q2">1</label></span>
                                        <span><input type="radio" id="two-q2" name="question_six" value="2">
                                <label for="two-q2">2</label></span>
                                        <span><input type="radio" id="three-q2" name="question_six" value="3">
                                <label for="three-q2">3</label></span>
                                        <span><input type="radio" id="four-q2" name="question_six" value="4">
                                <label for="four-q2">4</label></span>
                                        <span><input type="radio" id="five-q2" name="question_six" value="5">
                                <label for="five-q2">5</label></span>
                                        <span><input type="radio" id="six-q2" name="question_six" value="6">
                                <label for="six-q2">6</label></span>
                                        <span><input type="radio" id="seven" name="question_six" value="7">
