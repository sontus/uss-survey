                ...
                <div class="col-12 main_card">
                    <div class="card w-100 h-100">
                        <div class="card-body">
                            ...
                            <br>
                            <form action="{{ route('page-fifty-eight-save')}}" method="POST">
                                @csrf
                                @if (checkVersion() == 'B' || checkVersion() == 'D')
                                    <input type="hidden" name="next_page" value="page-fifty-nine">
                                @else
                                    <input type="hidden" name="next_page" value="page-fifty-nine">
                                @endif
                                <input type="hidden" name="current_page" value="58">
                                <input type="hidden" name="question_set" value="All">
                                <input type="hidden" name="question_part" value="L">
                                <div class="question">
                                    <p><strong>PART L: Please respond to the following questions.</strong></p>


                                    <p>(1) To what extent do you believe your decision to share descriptions of your
                                        shortcuts with your colleagues is contributing to the improvement of Festina's
                                        performance?</p>
