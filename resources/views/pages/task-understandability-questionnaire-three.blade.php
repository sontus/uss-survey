                ...
                <div class="col-12 main_card">
                    <div class="card w-100 h-100">
                        <div class="card-body">
                            ...
                            <br>
                            <div class="question">
                                <p>3. Let’s assume box 2 of page 6 contains 18 search letter “R”. In which cell would
                                ...
                                <img class="img-fluid mt-3" src="{{ asset('assets/images/Questionnaire-three.png')}}"
                                     alt="task-three">

                            </div>
                            <div class="cm_btn d-flex justify-content-between ">
                                <a href="{{ route('task-understandability-questionnaire-two')}}" type="button"
                                   class="btn pre_btn btn-danger btn-sm">Previous</a>
                                <a href="{{ route('task-understandability-questionnaire-four')}}"
        ...
        $('.nextButton').click(function (e) {
            ...
            if (value !== 'cellB') {
                let title = '<i class="fa-solid fa-triangle-exclamation text-danger"></i> Warning',
                    message = 'To find the correct cell to record you answer, look at the box numbers listed at the top row and page numbers listed on the left column. You need to find the column for box number 2 and then scroll down to the row for page number 6.';
