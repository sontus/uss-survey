                        ...
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col col-md-5">
                                        <div class="text-end mb-2">
                                            <span class="me-3 d-flex align-items-center justify-content-end">
                                                Time Remaining
                            ...
                            <div class="cm_btn d-grid gap-2 d-md-flex justify-content-md-end ">
                                <form action="{{ url('time_Up') }}" method="post">
                                    @csrf
                                    <input type="hidden" name="redirectTo" value="shortcuts-discovered-in-this-period">
                                    <input type="hidden" name="timeTag" value="viewResultProductionOneTimeLeft">
                                    <input type="hidden" class="timeLeft" name="timeLeft">
                                    <button id="stopViewBtn" type="submit" style="padding: 5px 20px 5px 20px;"
...
@push('page-js')
    <script>
        if (sessionStorage.getItem("showResultTimeRemaining") !== null) {
            let leftTime = sessionStorage.getItem("showResultTimeRemaining");
        ...
        function countdown(elementName, minutes, seconds, speEndTime) {
            ...
            function updateTimer() {
                ...
                if (msLeft < 1000) {
                    {{--                    @php --}}
                    {{--                        session()->put('viewResultTime','up'); --}}
                    {{--                    @endphp --}}
                    $('.timeLeft').val('up');
                    $('.stopViewButton').click()
                    sessionStorage.setItem("showResultTimeUp", 'up');
                    ...
                    $('.timeLeft').val(msLeft);
                    sessionStorage.setItem("showResultTimeRemaining", time.getUTCSeconds());
