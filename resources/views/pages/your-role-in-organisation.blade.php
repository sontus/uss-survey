                ...
                <div class="col-12 main_card">
                    <div class="card w-100 h-100">
                        <div class="card-body">
                            ...
                            <br>
                            <div class="question">
                                <p>As you are familiar with the task completed in the first phase, in this phase you are
                                    required to imagine yourself in the role of an employee who does a similar type of
                                    task for living. Please read the following section carefully as it explains the role
                                    that you need to imagine in this experiment</p><br>
                                ...
                                <p>Imagine that you work as an employee of an organisation called ‘Festina Services’.
                                    ...
                                    benefit the organisation. </p>
                                <p>The tasks that you have done earlier in this experiment represents what Festina does
                                    for fixing computer error codes for its clients. At Festina, you work in one of its
                                    coding teams that consists of five employees. The members of your team includes you
                                    and four of your colleagues. </p>
                            </div>
                            <div class="cm_btn d-grid gap-2 d-md-flex justify-content-md-end ">

                                <a href="{{ route('your-role-in-organisation-understandability-questionnaire')}}"
