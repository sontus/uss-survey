@extends('layouts.app')
@section('title', 'Production Period-1')
@push('vendor-css')
@endpush
@push('page-css')
    <style>
    ...
    <div class="container">
        <div class="row mainView">
            <h5 class="text-center mt-3 mb-2 ">
                <span class="border border-dark p-1">Production Period-1</span>
            </h5>
            ...
            <div class="col-sm-6 col-md-6">
                ...
                <div class=" questionArea">
                    {{-- pages --}}
                    @include('pages.production_one.page_one')
                </div>
                {{-- </div> --}}
            </div>
        </div>
...
@push('page-js')
    <script>
        var period = "Production-Period-1";
        $(document).ready(function () {
            @if (session()->get('productionOneTimeUp') !== 'up')
            // sessionStorage.clear('correct-production-1');
            @endif
        })
        ...
        function pageChange(pageNo) {
            ...
            switch (pageNo) {
                case 1:
                    qArea.html(`@include('pages.production_one.page_one')`);
                    break;
                case 2:
                    qArea.html(`@include('pages.production_one.page_two')`);
                    break;
                case 3:
                    qArea.html(`@include('pages.production_one.page_three')`);
                    break;
                case 4:
                    qArea.html(`@include('pages.production_one.page_four')`);
                    break;
                case 5:
                    qArea.html(`@include('pages.production_one.page_five')`);
                    break;
                case 6:
                    qArea.html(`@include('pages.production_one.page_six')`);
                    break;
                case 7:
                    qArea.html(`@include('pages.production_one.page_seven')`);
                    break;
                case 8:
                    qArea.html(`@include('pages.production_one.page_eight')`);
                    break;
                case 9:
                    qArea.html(`@include('pages.production_one.page_nine')`);
                    break;
                case 10:
                    qArea.html(`@include('pages.production_one.page_ten')`);
                    break;
                case 11:
                    qArea.html(`@include('pages.production_one.page_eleven')`);
                    break;
                case 12:
                    qArea.html(`@include('pages.production_one.page_twelve')`);
                    break;
                case 13:
                    qArea.html(`@include('pages.production_one.page_thirteen')`);
                    break;
                case 14:
                    qArea.html(`@include('pages.production_one.page_fourteen')`);
                    break;
                case 15:
                    qArea.html(`@include('pages.production_one.page_fifteen')`);
                    break;
                case 16:
                    qArea.html(`@include('pages.production_one.page_sixteen')`);
                    break;
                case 17:
                    qArea.html(`@include('pages.production_one.page_seventeen')`);
                    break;
                case 18:
                    qArea.html(`@include('pages.production_one.page_eighteen')`);
                    break;
                case 19:
                    qArea.html(`@include('pages.production_one.page_nineteen')`);
                    break;
                case 20:
                    qArea.html(`@include('pages.production_one.page_twenty')`);
                    break;
            }
        }
        ...
        $(".ans_input").blur(function () {
            ...
            let corAns = sessionStorage.getItem("correct-production-1");
            if (corAns == null) {
                corAns = 0;
            }
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data === true) {
                        ...
                        sessionStorage.setItem("correct-production-1", corAns);
        ...
        function countdown(elementName, minutes, seconds) {
            ...
            function updateTimer() {
                ...
                if (msLeft < 1000) {
                    if (minutes > 0) {
                        collectAllAns();
                        // sessionStorage.setItem("productionOneTimeUp", 'up');
                        @php
                            session()->put('productionOneTimeUp', 'up');
                        @endphp
                    }
                } else {
        ...
        // if time is over (8 min)
        // if (sessionStorage.getItem("productionOneTimeUp") === 'up') {
        //     window.location = 'shortcuts-discovered-in-this-period';
        // }
