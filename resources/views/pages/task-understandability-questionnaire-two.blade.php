                ...
                <div class="col-12 main_card">
                    <div class="card w-100 h-100">
                        <div class="card-body">
                            ...
                            <div class="question">
                                <div>
                                    <p> 2. If you wish to move to the page number 13 from the page shown below, which
                                        button would you click?</p>
                                ...
                                <img class="img-fluid" src="{{ asset('assets/images/Questionnaire-two.png')}}"
                                     alt="task-three">

                            </div>
                            <div class="cm_btn d-flex justify-content-between ">
                                <a href="{{ route('task-understandability-questionnaire')}}" type="button"
                                   class="btn pre_btn btn-danger btn-sm">Previous</a>
                                <a href="{{ route('task-understandability-questionnaire-three')}}"
...
@push('page-js')
    <script>
        ...
        $('.nextButton').click(function (e) {
            ...
            if (value === 'previewButton') {
                let title = '<i class="fa-solid fa-triangle-exclamation text-danger"></i> Warning',
                    message = 'To find the correct button, you need to notice the page number of your current page. In this example, you are currently on page 12 as shown in the top centre of your screen. Therefore to move to page number 13, you need to click on ‘Next Page’ button.';
