                            ...
                            <form action="{{ route('sharing-information-with-colleagues-ans-final')}}" method="POST">
                                ...
                                <div class="question">
                                    <input type="hidden" name="next_page"
                                           value="options_to_share_information_with_colleagues_four">
                                    <input type="hidden" name="current_page" value="38">
                                ...
                                <div class="cm_btn d-flex justify-content-between ">
                                    ...
                                    <a href="{{ route('Post_experimental_questionnaire_one')}}"
...
@push('page-js')
    <script>
        ...
        nextButton.click(function () {
            ...
            if (valueForOne === '2' && valueForTwo === 'true' && valueForThree === 'all') {
