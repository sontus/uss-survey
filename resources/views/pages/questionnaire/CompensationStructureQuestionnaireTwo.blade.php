@extends('layouts.app')
@section("title","Compensation Structure Questionnaire Two")
@push('vendor-css')
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="question">
                                    ...
                                    <ul style="list-style-type:'1.';">
                                        <li>&nbsp;&nbsp;The member who completes the most number of correct answer
                                            receives a bonus
                                        </li>
                                    </ul>
                                ...
                                <div class="cm_btn d-flex justify-content-between ">
                                    <a href="{{ route('compensation-structure-two')}}" type="button"
