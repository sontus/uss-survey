                ...
                <div class="col-12 main_card">
                    <div class="card w-100 h-100">
                        <div class="card-body">
                            ...
                            <br>
                            <form action="{{ route('post-experimental-step-three')}}" method="POST">
                                @csrf

                                @if (checkVersion() == "A" || checkVersion() == "C")
                                    <input type="hidden" name="next_page" value="Post_experimental_questionnaire_nine">
                                @elseif(checkVersion() == "A" || checkVersion() == "B")
                                    <input type="hidden" name="next_page" value="Post_experimental_questionnaire_nine">
                                @elseif(checkVersion() == "B" || checkVersion() == "D")
                                    <input type="hidden" name="next_page" value="Post_experimental_questionnaire_nine">
                                @else
                                    <input type="hidden" name="next_page" value="Post_experimental_questionnaire_eight">
                                @endif
                                {{-- <input type="hidden" name="next_page" value="Post_experimental_questionnaire_seven"> --}}
                                <input type="hidden" name="current_page" value="47">
                                <input type="hidden" name="question_set" value="All">
                                <input type="hidden" name="question_part" value="C">
                                <div class="question">
                                    <p><strong>PART C: Please respond to the following questions.</strong></p>
                                    <p>To what extent do you feel competitive against the colleagues who would be able
                                        to view your answer sheets?</p>
                                    <br><br>
