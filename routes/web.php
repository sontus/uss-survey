...
Route::middleware('auth')->group(function () {
    ...
    Route::get('short-cut/report',[ReportController::class,'ShortCutView'])->name('shortcut.report');
...
// new 26
Route::post('/page-twenty-six-save',[HomeController::class,'PageTwentySixSave'])->name('page-twenty-six-save')->middleware(['preventBackHistory','prolificValidation']);
// new 27
Route::get('/page-twenty-seven',[HomeController::class,'PageTwentySeven'])->name('page-twenty-seven')->middleware(['preventBackHistory','prolificValidation']);
// Page 26
...
// page 36 new
Route::get('/sharing-of-knowledge-with-colleagues', [HomeController::class, 'sharingOfKnowledgeWithColleagues'])->name('sharing-of-knowledge-with-colleagues')->middleware(['preventBackHistory', 'prolificValidation']);
// page 36
...
Route::get('/options_to_share_information_with_colleagues_three',[HomeController::class,'optionsToShareInformationWithColleaguesThree'])->name('options_to_share_information_with_colleagues_three')->middleware(['preventBackHistory','prolificValidation']);
//page 40 A & B
